...
function ContactPage() {
  ...
  const schema = yup.object().shape({
    ...
    areaCode: yup.string().required().matches(/^\d{3}$/, "Invalid Area Code"),
    phoneNumber: yup.string().required().matches(/^\d{1,8}$/, "Invalid Phone Number"),
  ...
  return (
    <>
      <div className="h-screen">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-stone-600 p-14 rounded-xl max-w-3xl mx-auto">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex gap-4 flex-1">
                <div className="w-1/4">
                  ...
                  {errors.areaCode && <p className="text-red-500">{errors.areaCode.message}</p>}
                </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <textarea className="w-full h-32 px-3 py-2 rounded bg-white border border-gray-300 resize-none" {...register("message")}/>
